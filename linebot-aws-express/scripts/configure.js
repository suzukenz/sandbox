...
const enableScheduled = args['schedule-expression'] ? 'ENABLED': 'DISABLED'
const scheduleExpression = args['schedule-expression'] ? args['schedule-expression'] : 'rate(10 minutes)'
...
modifyFiles(['./simple-proxy-api.yaml', './package.json', './cloudformation.yaml'], [{
  ...
  regexp: /YOUR_LAMBDA_FUNCTION_IS_SCHEDULED_OR_NOT/g,
  replacement: enableScheduled
}, {
  regexp: /YOUR_LAMBDA_FUNCTION_SCHEDULE_EXPRESSION/g,
  replacement: scheduleExpression
}])
